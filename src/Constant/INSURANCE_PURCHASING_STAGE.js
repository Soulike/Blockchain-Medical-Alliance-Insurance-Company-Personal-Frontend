export const INSURANCE_PURCHASING_STAGE_ID = {
    ...
    NORMAL: {   // 正常步骤
        APPLICATION: 0, // 投保人申请
        INSURANCE_COMPANY_PERSONAL_VERIFY: 1,      // 保险公司审核
        PAY: 2,         // 投保人缴费，保险公司确认并发布保单
        COMPLETE: 3,    // 完成
    },
    DECLINE: {  // 被拒绝步骤，正常步骤取负值
        INSURANCE_COMPANY_PERSONAL_VERIFY_DECLINED: -1,
    },
};
...
export const INSURANCE_PURCHASING_STAGE_ID_TO_TEXT = {
    ...
    [INSURANCE_PURCHASING_STAGE_ID.NORMAL.INSURANCE_COMPANY_PERSONAL_VERIFY]: '等待公司审核',      // 保险公司审核
