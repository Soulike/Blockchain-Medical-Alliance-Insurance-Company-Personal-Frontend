export const DIRECT_PAYMENT_STAGE_ID = {
    ...
    NORMAL: {
        ...
        INSURANCE_COMPANY_PERSONAL_VERIFY_AND_PAY: 2,    // 待保险公司审核及支付
        HOSPITAL_CONFIRM_PAYMENT: 3,            // 医院已确认收款
        COMPLETE: 4,                            // 完成
    },
    DECLINE: {
        HOSPITAL_CONFIRM_PAYABLE_DECLINED: -1,            // 医院确认不可直付
        INSURANCE_COMPANY_PERSONAL_VERIFY_AND_PAY_DECLINED: -2,    // 保险公司审核不通过
    },
};
...
export const DIRECT_PAYMENT_STAGE_ID_TO_TEXT = {
    ...
    [DIRECT_PAYMENT_STAGE_ID.NORMAL.INSURANCE_COMPANY_PERSONAL_VERIFY_AND_PAY]: '公司审核付款',
